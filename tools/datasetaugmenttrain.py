...
def load_metadata(dataset, csv_file):
    ...
    if dataset == 'AudioCaps' and 'train' in csv_file:
        ...
        caption_field = ['caption_{}'.format(i) for i in range(1, 10)]   ###original is 6
    ...
    for split in splits:
        ...
        with h5py.File(hdf5_path+'{}.h5'.format(split), 'w') as hf:
            ...
            if split == 'train' and dataset == 'AudioCaps':
                ...
                hf.create_dataset('caption', shape=(audio_nums, 10), dtype=h5py.special_dtype(vlen=str))   ##original 5
